...
export class News extends Component {
  ...
  static propTypes = {
    ...
    constructor(props){
        ...
        document.title = `NewsZ - ${this.capitalizeFirstLetter(this.props.category)}`; 
    }
    ...
    async updateNews(){
      ...
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=df43e58beec94ff68e70c29c333f08c1&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      <>
        <h1 className="text-center" style={{margin: '35px'}}>NewsZ - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
